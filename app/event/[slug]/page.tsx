  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        if (result.success) {
          const foundKegiatan = result.data.find(
            (item: Kegiatan) => item.slug === slug
          );
          if (foundKegiatan) {
            setData(foundKegiatan);
          } else {
            setNotFound(true);
          }
        }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400 mb-6">Kegiatan tidak ditemukan</p>
          <Link
            href="/"
            className="inline-block bg-gradient-to-r from-purple-600 to-fuchsia-600 text-white px-6 py-3 rounded-lg font-semibold hover:from-purple-700 hover:to-fuchsia-700 transition-all"
          >
            Kembali ke Beranda
          </Link>
        </div>
  ...
  return (
    <div className="min-h-screen py-28 px-4 md:px-8">
      <div className="md:px-3 mx-auto">
        ...
        >
          <h1 className="text-4xl font-funky md:text-6xl  mb-4">
            <GradientText
          ...
          <p className="text-gray-200  text-sm md:text-xl max-w-3xl mx-auto">
            {data.description}
          </p>
        </motion.div>
